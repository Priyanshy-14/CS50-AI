...
class Sentence():
    ...
    def known_mines(self):
        ...
        If the number of cells equals the count, all remaining cells are mines.
        """
    ...
    def known_safes(self):
        ...
        If count is 0, every cell in the sentence is safe.
        """
        if self.count == 0:
            return set(self.cells)
        return set()
...
class MinesweeperAI():
    ...
    def __infer_knowledge(self):
        ...
        while made_progress:
            ...
            # --- A. Direct implications (all‑mines / all‑safes) ---
            safes_to_mark = set()
            mines_to_mark = set()
            for sentence in self.knowledge:
            ...
            for s1 in self.knowledge:
                for s2 in self.knowledge:
                    ...
                    if s1.cells and s1.cells < s2.cells:
                        ...
                        if new_s not in self.knowledge and new_s not in new_sentences and diff_cells:
